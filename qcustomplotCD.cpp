...
void QCPColorGradient::loadPreset(GradientPreset preset)
{
  ...
  switch (preset)
  {
    ...
    case gpPolar:
      ...
      /*setColorStopAt(0, QColor(50, 255, 255));
      setColorStopAt(0.2, QColor(10, 70, 255));
      setColorStopAt(0.4, QColor(10, 10, 190));
      setColorStopAt(0.6, QColor(0, 0, 0));
      setColorStopAt(0.8, QColor(190, 10, 10));
      setColorStopAt(0.9, QColor(255, 70, 10));
      setColorStopAt(1, QColor(255, 255, 50));*/
      break;
    case gpSpectrum:
      setColorInterpolation(ciHSV);
